        ...
        <main className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
            ...
            <div className="flex flex-col lg:flex-row w-full">
                ...
                <section className="w-full lg:w-1/2 bg-gradient-to-br from-slate-100 to-slate-50 min-h-[50vh] lg:min-h-screen lg:sticky lg:top-16 p-4 sm:p-6 flex items-center justify-center">
                    {imageUrl && resumeUrl ? (
                        <div className="animate-in fade-in duration-1000 w-full max-w-2xl">
                            <div className="bg-white rounded-2xl shadow-2xl p-3 sm:p-4 border-2 border-slate-200">
                                ...
                                <div className="mt-3 sm:mt-4 flex items-center justify-center gap-2 text-xs sm:text-sm text-slate-600">
                ...
                <section className={`${showPreview ? 'w-full lg:w-1/2' : 'w-full'} px-4 sm:px-6 lg:px-12 py-8 sm:py-12 space-y-6 sm:space-y-8 max-w-7xl mx-auto`}>
                    ...
                    {feedback ? (
                        <div className="space-y-4 sm:space-y-6 animate-in fade-in duration-1000">
                            <Summary feedback={feedback} />
                            <ATS score={feedback.ATS.score || 0} suggestions={feedback.ATS.tips || []} />
                            <Details feedback={feedback} />
                            
                            {/* Action Buttons */}
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-6 sm:pt-8 border-t-2 border-slate-200">
                                <Link 
                                    to="/hirelens/upload"
                                    className="flex-1 px-4 sm:px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm sm:text-base font-semibold rounded-xl shadow-lg hover:shadow-xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 text-center"
                                >
                                    Analyze Another Resume
                                </Link>
                                <button 
                                    onClick={() => window.print()}
                                    className="flex-1 px-4 sm:px-6 py-3 bg-white text-slate-700 text-sm sm:text-base font-semibold rounded-xl shadow-md hover:shadow-lg border-2 border-slate-200 hover:border-purple-300 transition-all duration-300 flex items-center justify-center gap-2"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex flex-col items-center justify-center py-12 sm:py-20 space-y-4 sm:space-y-6">
                            <div className="relative">
                                <div className="animate-spin rounded-full h-16 sm:h-20 w-16 sm:w-20 border-4 border-purple-600 border-t-transparent"></div>
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <svg className="w-6 sm:w-8 h-6 sm:h-8 text-purple-600 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                    </svg>
                                </div>
                            </div>
                            <div className="text-center">
                                <p className="text-lg sm:text-xl font-semibold text-slate-700 mb-2">Analyzing Your Resume</p>
                                <p className="text-sm sm:text-base text-slate-600">Our AI is reviewing your resume... This may take a few moments.</p>
                            </div>
                        </div>
                    )}
                </section>
