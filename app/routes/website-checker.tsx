                    ...
                    <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 border border-slate-200">
                      <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 via-cyan-50 to-slate-50 border-2 border-blue-200">
                        ...
                        <div className="p-6 sm:p-8 lg:p-10">
                          ...
                          <div className="mb-8">
                            <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-blue-100">
                              <div className="flex items-baseline justify-center gap-2 mb-4">
                                <span className="text-slate-500 text-lg line-through">$12.99</span>
                                <span className="text-5xl sm:text-6xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                                  $0.99
                                </span>
                                <span className="text-slate-600 text-lg">/year</span>
                              </div>
                              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-orange-500 to-red-500 rounded-full mx-auto">
                                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="text-xs font-bold text-white">92% OFF - Limited Time</span>
                              </div>
                            </div>
                          </div>
                          ...
                          {/* Premium CTA Button */}
                          <a
                            href={`https://www.hostinger.com/domain-checker?domain=${result.domainName}`}
                            target="_blank"
