...
const QuickBMISection = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl shadow-2xl overflow-hidden border border-green-100">
          <div className="p-8 sm:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Calculate your Body Mass Index instantly and get AI-powered health insights personalized for you.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="bg-white rounded-xl p-6 shadow-sm border border-green-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-bold text-slate-900">Accurate BMI</h3>
                </div>
                <p className="text-sm text-slate-600">Get precise BMI calculations based on your age, gender, height, and weight.</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-green-100">
                ...
                <p className="text-sm text-slate-600">Receive personalized diet, activity, and lifestyle recommendations powered by AI.</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-green-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-bold text-slate-900">Health Goals</h3>
                </div>
                <p className="text-sm text-slate-600">Get customized tips to help you reach and maintain your ideal healthy weight.</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-green-100">
                ...
                <p className="text-sm text-slate-600">Simple, intuitive interface that works perfectly on all devices.</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link
                to="/bmi-calculator"
                className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
              ...
              <p className="mt-4 text-sm text-slate-500">Free • No signup required • Instant results</p>
            </div>
          </div>
        </div>
      </div>
